...
force force VCM_ARTYDELAY = 2500;
force force VCM_ARTYENABLE = true;
force force VCM_ARTYSIDES = [EAST];
...
force force VCM_RAGDOLLCHC = 16.4821;
force force VCM_SIDEENABLED = [EAST];
...
force force VCM_WARNDELAY = 5000;
force force VCM_WARNDIST = 3000;
...
cScripts_Settings_setMissionType = 4;
